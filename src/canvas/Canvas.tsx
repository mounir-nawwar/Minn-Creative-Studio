        ...
        {pendingNodeType && (
          <>
            ...
            <motion.div
              ...
              exit={{ y: -20, opacity: 0 }}
              className="fixed top-20 left-1/2 -translate-x-1/2 z-[10000] bg-[#0097A7] text-white px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-2xl border border-white/20 flex items-center gap-2"
            >
